...
class ThymioController:
    ...
    def __init__(self):
        ...
        model_path = rospkg.RosPack().get_path('learning_to_drive') + '/saved_models/model_MobileNet_best_mse.h5'
    ...
    def image_callback(self, data):
        ...
        try:
            ...
            # get predictions
            self.angleness, self.centerness = self.model.predict(im[np.newaxis, :, :, :])

            print(self.angleness, self.centerness)
